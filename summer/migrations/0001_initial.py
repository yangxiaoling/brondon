# Generated by Django 2.2.2 on 2019-07-15 01:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='summer.Asset')),
            ],
            options={
                'verbose_name': '服务器',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='summer.Asset')),
                ('firmware', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='summer.Software')),
            ],
            options={
                'verbose_name': '网络设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='summer.Asset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='parent_level', to='summer.BusinessUnit')),
            ],
            options={
                'verbose_name': '业务线',
        ...
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='summer.BusinessUnit', verbose_name='所属业务线'),
        ),
        migrations.AddField(
            model_name='asset',
            name='contract',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='summer.Contract', verbose_name='合同'),
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='summer.IDC', verbose_name='IDC机房'),
        ),
        migrations.AddField(
            model_name='asset',
            name='manufactory',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='summer.Manufactory', verbose_name='制造商'),
        ),
        migrations.AddField(
            model_name='asset',
            name='tags',
            field=models.ManyToManyField(blank=True, to='summer.Tag'),
        ),
        migrations.CreateModel(
            name='RAM',
            fields=[
